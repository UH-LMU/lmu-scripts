...
Explanation:
 ...
 destionation_dir: a optional destination dir, default it is unset
                    (starting from the mount_point)
 bakup_name:       a name for the backup, default BAKUP
 bakup_level:      the number of backups to preseve, default 5, min 2
...
Example:
 ...
 make_snapshot.bash /dev/hdd15 /root/backup /home/ -d home -N daily -m 10;
 make_snapshot.bash /dev/hdd15 /root/backup /home/ -d home -N daily -m 10 \\
